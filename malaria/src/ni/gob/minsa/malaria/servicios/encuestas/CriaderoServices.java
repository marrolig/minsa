...
public interface CriaderoServices {
	 ...
	 * @param pObjeto Objeto que almacenara los tipos {@link DivisionPolitica} {@link Comunidad} {@link EntidadAdtva} en dependencia al tipo de busqueda
	 * @return Objeto {@link InfoResultado} con el resultado de la operación
	 */
	public InfoResultado obtenerCriaderos(int pPaginaActual, int pRegistroPorPagina, String pFieldSort, Boolean pSortOrder, Object pObjeto);
