...
// Sistema.java
// -----------------------------------------------
package ni.gob.minsa.malaria.modelo.portal;
...
public class Sistema implements Serializable {
	...
	/**
	 * Establece el código asignado a la aplicación o sistema.
	 */
	 ...
	 * se dirige la acción desde el portal de aplicaciones
	 */
	...
	/**
	 * Establece el valor de la url de la página inicial del sistema
	 * para dirigir la acción cuando se solicita ingresar al sistema
	...
	/**
	 * Obtiene la url de la pagina inicial del sistema a la cual
	 * se dirige la acción desde el portal de aplicaciones cuando
	 * es llamada desde la intranet
	 * 
	 * @return Cadena con la url de la página inicial de la aplicación
	 */
	 ...
	 * Establece el valor de la url de la página inicial del sistema
	 * para dirigir la acción cuando se solicita ingresar al sistema
	 * desde el portal de aplicaciones desde la intranet de la institución
	 * 
	 * @param urlInicioIntranet Cadena con la url de la página inicial de la aplicación
	 */
