...
import ni.gob.minsa.malaria.modelo.general.SistemaCatalogo;
...
public class BaseEntidadCatalogo extends BaseEntidadCreacion {
	...
	@OneToMany(mappedBy="catalogo",
			   targetEntity=ni.gob.minsa.malaria.modelo.general.SistemaCatalogo.class,
			   fetch=FetchType.LAZY)
	private Set<SistemaCatalogo> sistemas;
	...
	public void setSistemas(Set<SistemaCatalogo> sistemas) {
		this.sistemas = sistemas;
	}

	public Set<SistemaCatalogo> getSistemas() {
		return sistemas;
	}
